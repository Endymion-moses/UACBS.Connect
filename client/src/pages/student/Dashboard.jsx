  ...
  return (
    <div className="flex min-w-0 flex-col">
      <div className="flex flex-col gap-4 pb-5 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div>
          <Link to ="/student/book" className="inline-flex w-full items-center justify-center rounded-2xl bg-blue-900 px-5 py-3 text-sm font-semibold text-white transition hover:bg-blue-700 sm:w-auto">
            + Book Consultation
          </Link>
        </div>
      </div>
          ...
          <div className="w-full border border-white bg-white rounded-3xl shadow-sm">
            ...
            <div className="p-5 flex flex-col gap-4">
              {recentAppointments.map((appointment) => (
                  <div key={appointment.id} className="flex flex-col gap-3 rounded-3xl border border-slate-200 p-4 hover:bg-gray-100 sm:flex-row sm:items-center sm:justify-between sm:gap-4">
                  <div className="min-w-0">
